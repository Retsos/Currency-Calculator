...
const RegisterForm = ({onSwitch}) => {
    ...
    const { token, isLoading, error, register: registerUser, clearError } = useAuthStore();
    ...
    //epivlepw tin timi tou password gia na to elegxw me to 2o password
